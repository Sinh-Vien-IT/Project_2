				...
				<div class="panel-body">
					...
					<form class="form-horizontal" role="form" method="POST" action=""  enctype = "multipart/form-data" id = "updateForm">
						...
						<div class="form-group">
							<label class="col-md-4 control-label">Hình Hiện Tại</label>
							<div class="col-md-6">
								<img src="{!!asset('resources/upload/banner/'.$banner->id.'/'.$banner->image)!!}" alt="" style="height:100px;width:100px" class="form-control" >
							</div>
