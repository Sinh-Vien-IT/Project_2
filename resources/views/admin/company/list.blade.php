			...
			<tbody>
				...
				@foreach($companies as $company)
					...
					<tr>
						...
						<td class = "center_align"><a onclick = "return confirm('Bạn có muốn xoá hãng sản xuất {!!$company->company_name!!} không?')" href="{!!url('admin/company/delete')!!}/{!!$company->id!!}">Xóa</a></td>
						<td>{!!$company->company_name!!}</td>
						<td class = "center_align"><img src="{!!url('resources/upload/company/'.$company->id)!!}/{!!$company->logo!!}" alt="" height="45px" width="45px"></td>
